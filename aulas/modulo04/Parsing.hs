...
npParser,nParser,dParser,sParser,vParser,vpParser :: Parser String String

nParser  = symbol "dwarf"  <|> symbol "wizard"

dParser  = symbol "every"  <|> symbol "some"    <|> symbol "no"

npParser = symbol "Alice"  <|> symbol "Dorothy" <|> (dParser <*> nParser)

vpParser = symbol "smiled" <|> symbol "laughed" <|> (vParser <*> npParser)
